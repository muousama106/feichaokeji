...
var GAME_CN_NAMES = {
    ...
    'The Elder Scrolls VI': '上古卷轴6',
    'Cyberpunk 2077: Orion': '赛博朋克2077：猎户座',
    'The Legend of Zelda: Tears of the Kingdom 2': '塞尔达传说：王国之泪2',
    'Overwatch 3': '守望先锋3',
    'Death Stranding 2': '死亡搁浅2',
    'Genshin Impact 6.0': '原神 6.0版本',
    'League of Legends Season 16': '英雄联盟 S16赛季',
    'World of Warcraft: The Darkest Night': '魔兽世界：至暗之夜',
    'Honkai: Star Rail 4.0': '崩坏：星穹铁道 4.0',
    'Apex Legends Season 26': 'Apex英雄 第26赛季',
    'Valorant Act 12': '无畏契约 第12幕',
    'Diablo IV: Vessel of Hatred': '暗黑破坏神4：憎恨之躯',
    'Hades II': '哈迪斯2',
    'Starfield 2': '星空2',
    'Metroid Prime 4': '银河战士Prime 4',
    'Crimson Desert': '红色沙漠',
    'Fable': '神鬼寓言',
    'Prince of Persia: The Sands of Time Remake': '波斯王子：时之砂 重制版',
    'Silent Hill 2 Remake': '寂静岭2 重制版',
    'Silent Hill Townfall': '寂静岭：城镇陨落',
    'Marvel\'s Wolverine': '漫威金刚狼',
    'Phantom Blade Zero': '影之刃零',
    'Gears of War: E-Day': '战争机器：E-Day',
    'Control Resonant': '控制：共鸣',
    'Assassin\'s Creed Back Flag Resynced': '刺客信条：黑旗重制',
    'Tomb Raider: Legacy of Atlantis': '古墓丽影：亚特兰蒂斯遗产',
    'No Rest for the Wicked': '恶意不息',
    'Kena: Scars of Kosmora': '凯娜：科斯莫拉之痕',
    'Persona 6': '女神异闻录6',
    'Metaphor: ReFantazio 2': '暗喻幻想2',
    'Resident Evil 9': '生化危机9',
    'Civilization VII': '文明7',
    'Black Myth: Wukong DLC': '黑神话：悟空 DLC',
    'Call of Duty: Modern Warfare IV': '使命召唤：现代战争4',
    'Perfect Dark': '完美黑暗',
    'DOOM: The Dark Ages': '毁灭战士：黑暗时代',
    'Everwild': '永恒荒野',
    'Dragon Age: Dreadwolf': '龙腾世纪：恐惧之狼',
    'Star Wars: Eclipse': '星球大战：日蚀',
    'The Witcher 4': '巫师4',
    'God of War: Ragnarok PC': '战神：诸神黄昏 PC版',
    'Horizon Forbidden West PC': '地平线：西之绝境 PC版',
    'Ghost of Tsushima 2': '对马岛之魂2',
    'Marvel\'s Spider-Man 3': '漫威蜘蛛侠3',
    'Tekken 8': '铁拳8',
    'Forza Horizon 6': '极限竞速：地平线6',
    'Final Fantasy XVI PC': '最终幻想16 PC版',
    'Like a Dragon: Infinite Wealth': '如龙：无限财富',
    'Metal Gear Solid Δ: Snake Eater': '合金装备Δ：食蛇者',
    'Persona 3 Reload': '女神异闻录3 重制版',
    'Suicide Squad: Kill the Justice League': '自杀小队：杀死正义联盟',
    'Baldur\'s Gate 3: Definitive Edition': '博德之门3 终极版',
    'Kingdom Hearts IV': '王国之心4',
    'Dragon\'s Dogma II: Dark Arisen': '龙之信条2：黑暗觉醒',
    'Splinter Cell Remake': '细胞分裂 重制版',
    'Half-Life 3': '半条命3',
    'The Last of Us Part III': '最后生还者 第三章',
    'Red Dead Redemption 3': '荒野大镖客：救赎3',
    'BioShock 4': '生化奇兵4',
    'Mass Effect 5': '质量效应5',
    'Fallout 5': '辐射5',
    'Bloodborne Remastered': '血源诅咒 高清重制',
    'Chrono Break': '时空之轮：破碎',
    'Onimusha: Way Of The Sword': '鬼武者：剑之道',
    'Warcraft IV': '魔兽争霸4',
    'Tom Clancy\'s Splinter Cell': '细胞分裂',
    'Replaced': '替代者',
    'Pragmata': '虚实万象',
    'The Blood Of Dawnwalker': '黎明行者之血',
    'Beast of Reincarnation': '轮回之兽',
    'Lords of the Fallen 2': '堕落之主2',
    'Valor Mortis': '死亡勇者',
    'End of Abyss': '深渊尽头',
    'Ace Combat 8: Wings of Theve': '皇牌空战8：泰夫之翼',
    'The Adventures of Elliot: The Millennium Tales': '艾略特历险记：千年传说',
    ...
    'NBA 2K27': 'NBA 2K27',
    'Madden NFL 27': '麦登橄榄球27',
    'Counter-Strike 2': 'CS2',
    'Destiny 2: The Final Shape': '命运2：最终形态',
    'Ark 2': '方舟2',
    'S.T.A.L.K.E.R. 2': '潜行者2',
    'Vampire: The Masquerade - Bloodlines 2': '吸血鬼：避世血族2',
    'Avowed': '宣誓',
    'Indiana Jones and the Great Circle': '夺宝奇兵：古老之圈',
    'Senua\'s Saga: Hellblade II': '地狱之刃2',
    'State of Decay 3': '腐烂国度3',
    'Clockwork Revolution': '发条革命',
    'South of Midnight': '午夜之南',
    'Contraband': '禁运品',
    'Project: Mara': '玛拉计划',
    'Exodus': '出埃及记',
    'Judas': '犹大',
    ...
    'Rise of the Rōnin': '浪人崛起',
    'Dragon\'s Dogma 2': '龙之信条2',
    'Test Drive Unlimited Solar Crown': '无限试驾：太阳王冠',
    'Killing Floor 3': '杀戮空间3',
    'Homeworld 3': '家园3',
    'Manor Lords': '庄园领主',
    'Nivalis': '云端赛博',
    'SILENT HILL f': '寂静岭 f',
    'Metal Gear Solid Δ': '合金装备Δ',
};

function getGameDisplayName(name) {
    return GAME_CN_NAMES[name] || name;
}
